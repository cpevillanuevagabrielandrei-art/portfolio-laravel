...
@section('topbar-actions')
    <a href="{{ route('portfolio.index') }}" target="_blank" class="btn-admin btn-admin-outline btn-admin-sm">
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.25rem">
    <div class="admin-card">
        ...
        <div class="quick-actions">
            ...
            <a href="{{ route('admin.skills') }}" class="btn-admin btn-admin-success">
                <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                Add Skill
            </a>
            <a href="{{ route('admin.settings') }}" class="btn-admin btn-admin-secondary">
    ...
    <div class="admin-card">
        ...
        <table class="system-info-table">
            <tr><td>Laravel</td><td>{{ app()->version() }}</td></tr>
            <tr><td>PHP</td><td>{{ PHP_VERSION }}</td></tr>
            <tr><td>Environment</td><td>{{ app()->environment() }}</td></tr>
            <tr><td>Logged in as</td><td>{{ auth()->user()->name }}</td></tr>
        </table>
    </div>
</div>

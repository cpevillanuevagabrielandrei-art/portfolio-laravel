...
<nav id="desktop-nav">
    <div class="logo">
        <span class="logo-text"><?php echo e($settings['name'] ?? 'John Doe'); ?></span>
...
<section id="profile">
    ...
    <div class="profile-inner">
        ...
        <div class="section__text hero-entrance hero-entrance-delay">
            ...
            <h1 class="title glitch-text" data-text="<?php echo e($settings['name'] ?? 'John Doe'); ?>"><?php echo e($settings['name'] ?? 'John Doe'); ?></h1>
            <p class="section__text__p2"><?php echo e($settings['subtitle'] ?? 'Frontend Developer'); ?></p>

            <div class="btn-container">
                <?php if(!empty($settings['resume_url'])): ?>
                    <a href="<?php echo e($settings['resume_url']); ?>" class="btn btn-outline magnetic-btn" target="_blank">
    ...
    <div class="section-container reveal">
        <div class="section__pic-container about-pic-wrap">
            ...
            <div class="about-pic-badge">
                <span>✦</span>
                <p><?php echo e($settings['experience_years'] ?? '2+'); ?></p>
...
<section id="contact">
    ...
    <div class="contact-wrapper reveal">
        <div class="contact-left">
            ...
            <div class="contact-methods">
                <?php if(!empty($settings['email'])): ?>
                    <a href="https://mail.google.com/mail/?view=cm&to=<?php echo e($settings['email']); ?>" class="contact-method glass-card" target="_blank">
                ...
                <?php endif; ?>
                <?php if(!empty($settings['linkedin_url'])): ?>
                    <a href="<?php echo e($settings['linkedin_url']); ?>" class="contact-method glass-card" target="_blank">
                        <div class="contact-method-icon">
        ...
        <div class="contact-right">
            ...
            <form method="POST" action="<?php echo e(route('portfolio.contact')); ?>" class="contact-form glass-card">
                <?php echo csrf_field(); ?>
                <div class="form-row">
                    <div class="form-group floating-label">
                        <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder=" " required />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group floating-label">
                        <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder=" " required />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group floating-label">
                    <input type="text" id="subject" name="subject" value="<?php echo e(old('subject')); ?>" placeholder=" " />
                    <label for="subject">Subject</label>
                </div>
                <div class="form-group floating-label">
                    <textarea id="message" name="message" placeholder=" " required><?php echo e(old('message')); ?></textarea>
...
<footer>
    <div class="footer-inner">
        <div class="footer-logo">
            <span><?php echo e($settings['name'] ?? 'Portfolio'); ?></span>
            <span class="logo-dot"></span>
        </div>

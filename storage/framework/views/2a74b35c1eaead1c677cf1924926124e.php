...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?> — CMS</title>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/sass/admin.scss', 'resources/js/admin.js']); ?>
</head>
<body>
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav>
            ...
            <a href="<?php echo e(route('admin.skills')); ?>"
               class="<?php echo e(request()->routeIs('admin.skills*') ? 'active' : ''); ?>">
                <span class="nav-icon">
            ...
            <a href="<?php echo e(route('admin.messages')); ?>"
               class="<?php echo e(request()->routeIs('admin.messages*') ? 'active' : ''); ?>">
                ...
                <?php if($unread > 0): ?>
                    <span class="badge badge-danger" style="margin-left:auto"><?php echo e($unread); ?></span>
                <?php endif; ?>
            </a>

            <div class="nav-divider"></div>

            <a href="<?php echo e(route('portfolio.index')); ?>" target="_blank" style="opacity:0.65">
                <span class="nav-icon">
...
</html><?php /**PATH C:\xampp\htdocs\portfolio-laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
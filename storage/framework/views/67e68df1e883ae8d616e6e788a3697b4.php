<?php $__env->startSection('page-title', 'Message from ' . $message->name); ?>
...
<div class="admin-card" style="max-width:720px">
    ...
    <div class="message-meta-grid">
        <div class="meta-item">
            ...
            <div class="meta-value"><?php echo e($message->name); ?></div>
        </div>
        <div class="meta-item">
            <div class="meta-label">Email</div>
            <div class="meta-value"><a href="mailto:<?php echo e($message->email); ?>"><?php echo e($message->email); ?></a></div>
        </div>
        <div class="meta-item">
            <div class="meta-label">Subject</div>
            <div class="meta-value"><?php echo e($message->subject ?? '(no subject)'); ?></div>
        </div>
        <div class="meta-item">
            <div class="meta-label">Received</div>
            <div class="meta-value"><?php echo e($message->created_at->format('M j, Y \a\t g:i A')); ?></div>
        </div>
    </div>
    ...
    <div style="display:flex;gap:0.75rem">
        ...
        <form method="POST" action="<?php echo e(route('admin.messages.destroy', $message)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\portfolio-laravel\resources\views/admin/message-show.blade.php ENDPATH**/ ?>
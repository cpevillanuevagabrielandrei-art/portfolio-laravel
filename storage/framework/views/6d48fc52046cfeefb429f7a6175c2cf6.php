...
<form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" enctype="multipart/form-data" class="admin-form">
    <?php echo csrf_field(); ?>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.25rem">
        ...
        <div class="admin-card">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="<?php echo e($settings['name'] ?? ''); ?>" placeholder="John Doe" />
            </div>
            <div class="form-group">
                <label>Job Title / Subtitle</label>
                <input type="text" name="subtitle" value="<?php echo e($settings['subtitle'] ?? ''); ?>" placeholder="Frontend Developer" />
            </div>
            <div class="form-group">
                <label>Experience Label</label>
                <input type="text" name="title" value="<?php echo e($settings['title'] ?? ''); ?>" placeholder="Frontend Development" />
            </div>
            <div class="form-group">
                <label>Years of Experience</label>
                <input type="text" name="experience_years" value="<?php echo e($settings['experience_years'] ?? ''); ?>" placeholder="2+ years" />
            </div>
            <div class="form-group">
                <label>Education</label>
                <textarea name="education" placeholder="B.Sc. Bachelors Degree&#10;M.Sc. Masters Degree"><?php echo e($settings['education'] ?? ''); ?></textarea>
            </div>
            <div class="form-group">
                <label>About Me</label>
                <textarea name="about_text" rows="5" placeholder="Tell visitors about yourself..."><?php echo e($settings['about_text'] ?? ''); ?></textarea>
            </div>
        </div>
        ...
        <div>
            <div class="admin-card">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="<?php echo e($settings['email'] ?? ''); ?>" placeholder="you@example.com" />
                </div>
                <div class="form-group">
                    <label>LinkedIn URL</label>
                    <input type="url" name="linkedin_url" value="<?php echo e($settings['linkedin_url'] ?? ''); ?>" placeholder="https://linkedin.com/in/..." />
                </div>
                <div class="form-group">
                    <label>GitHub URL</label>
                    <input type="url" name="github_url" value="<?php echo e($settings['github_url'] ?? ''); ?>" placeholder="https://github.com/..." />
                </div>
                <div class="form-group">
                    <label>Resume / CV URL</label>
                    <input type="url" name="resume_url" value="<?php echo e($settings['resume_url'] ?? ''); ?>" placeholder="https://..." />
                ...
                <div class="form-group">
                    ...
                    <div class="image-preview-wrap">
                        <img id="profile_pic_preview"
                            src="<?php echo e(!empty($settings['profile_pic']) ? asset('storage/'.$settings['profile_pic']) : asset('assets/profile-pic.png')); ?>"
                ...
                <div class="form-group" style="margin-top:1.25rem">
                    ...
                    <div class="image-preview-wrap">
                        <img id="about_pic_preview"
                            src="<?php echo e(!empty($settings['about_pic']) ? asset('storage/'.$settings['about_pic']) : asset('assets/about-pic.png')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\portfolio-laravel\resources\views/admin/settings.blade.php ENDPATH**/ ?>